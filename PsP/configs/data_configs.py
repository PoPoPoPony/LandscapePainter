...
DATASETS = {
	...
	'landscape': {
		'transforms': transforms_config.SegToImageTransforms2,
		'train_source_root': dataset_paths['landscape_train_anno'],
		'train_target_root': dataset_paths['landscape_train_img'],
		'test_source_root': dataset_paths['landscape_test_anno'],
		'test_target_root': dataset_paths['landscape_test_img'],
	}
}
